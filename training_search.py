...
from sentence_transformers.cross_encoder import BHNS_CrossEncoder
from sentence_transformers.cross_encoder.evaluation import CECorrelationEvaluator, CrossEncoderNDCGEvaluator, CERerankingEvaluator
...
model = BHNS_CrossEncoder('cross-encoder/ms-marco-MiniLM-L-2-v2', num_labels=1)
...
model = BHNS_CrossEncoder(model_save_path)
